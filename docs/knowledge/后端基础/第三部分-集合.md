...
好的！我明白了你的风格，让我按照前面 Collections 工具类的格式来整理 Map 的常用方法，注重文字表达的自然流畅：
...
这三个方法分别返回键的集合、值的集合、键值对条目的集合。它们都是"视图"，修改会影响原 Map。
...
这样整理后，每个方法都有清晰的说明和实用的例子，你觉得如何？

好的！让我继续按照你的风格来整理遍历方式这部分，保持文字表达的自然流畅：
