...
![](../../public/images/文章资源/java入门-基础语法/file-20250626152019764.jpg)
...
![](../../public/images/文章资源/java入门-基础语法/file-20250626152355572.jpg)
...
![](../../public/images/文章资源/java入门-基础语法/file-20250626152408557.jpg)
...
当然，下面我会结合你的原始内容，把“程序中的特殊注释”这块补全成一份风格统一、内容完整的笔记，并适当拓展一些常见的特殊注释标签和实际开发中的用法。
...
>
> 这是因为前面的方法只读取值而不读取回车符，而 nextLine()会读取这个遗留的回车符。解决方法是在它们之间加一个额外的 scanner.nextLine()来"吃掉"这个回车符。
